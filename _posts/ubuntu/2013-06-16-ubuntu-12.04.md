...
* [Properly display GTK3 apps in MATE Desktop Environment](http://ubuntu-tricks.com/properly-display-gtk3-apps-in-mate-desktop-environment/)
        ...
        sudo apt-get update && sudo apt-get install -y faenza-icon-theme
...
ref. [How to install VNC server on Ubuntu Server 12.04](rbgeek.wordpress.com/2012/06/25/how-to-install-vnc-server-on-ubuntu-server-12-04/)
