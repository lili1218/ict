...
安裝中文套件
    ...
    sudo apt-get install -y language-support-zh language-support-fonts-zh language-support-input-zh language-support-translations-zh language-pack-zh language-pack-zh-base language-pack-gnome-zh language-pack-gnome-zh-base
